...
importScripts('/sms-cloud/app/js/protocols/ipdl.js');
importScripts('/sms-cloud/app/js/protocols/bridge.js');
importScripts('/sms-cloud/app/js/protocols/protocol.js');
